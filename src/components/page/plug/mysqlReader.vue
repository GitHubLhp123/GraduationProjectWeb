<template>
    <div>
        ...
        <el-form label-width="100px" class="demo-ruleForm" :val="mysqlReaderData">
...
<script>
    ...
    export default {
        ...
        watch: {
            mysqlReaderData: {//深度监听，可监听到对象、数组的变化
                handler(val, oldVal) {
                    console.log(this.mysqlReaderData);
                    this.$emit('input', this.mysqlReaderData);
                },
                deep: true
            }
        },
